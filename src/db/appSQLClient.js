...
const getConfig = (mode) => { 
  const local = {
    ...
    user     : 'root',
    password : '',
    database : 'soma_db_32fhd',
   } 

   const live  = {
    host     : 'localhost',
    user     : 'soma_usr_db_32fhd',
...
const pool = mysql.createPool(getConfig('live')); // si es cpanel enviar live, si es local enviar local o cualquier otra cosa.
